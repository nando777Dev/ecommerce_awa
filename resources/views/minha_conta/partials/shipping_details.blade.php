...
<section id="cart" class="padding">
    <div class="container" style="width: 95%; height: 50%">
        <ul class="breadcrumb">
            <li><a href="/minha-conta/minhas-compras">Minhas Compras</a></li>
                ...
                <div class="shop_measures margintop40">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><h5><span id="cart-subtotal">{{ $pedido->billing_type}}</span></h5></td>
                        </tr>
                        <tr>
                            <td>Qdt. Parcelas</td>
                            <td class="text-right"><h5><span id="cart-subtotal">{{ $pedido->quantidade_parcela}}</span></h5></td>
                        </tr>
                        <tr>
                            <td>Valor parcelas</td>
                            <td class="text-right"><h5>R$<span id="cart-subtotal">{{ number_format($pedido->valor_parcela, '2', '.', ',')}}</span></h5></td>
                        </tr>

                        <tr>
                            <td>Total</td>
                            <td class="text-right"><h5 class="price">R$<span id="cart-total">{{ number_format($pedido->valor_before_taxa, '2', '.', ',') }}</span></h5></td>
                        </tr>
                        </tbody>
                    </table>
