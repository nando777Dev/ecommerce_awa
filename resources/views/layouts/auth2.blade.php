...
<header>
    <nav class="navbar navbar-default navbar-sticky bootsnav">
        <div class="container">
                        ...
                        <ul class="dropdown-menu megamenu-content" role="menu">
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-menu col-md-3">
                                        <div class="content">
                                            <img src="../../../assets/images/mega-menu.png" alt="menu" class="img-responsive">
                                        </div>
                                    </div>
                                </div>
                            </li>
            ...
            <ul class="cart-list">
                <li>
                    <a href="#." class="photo"><img src="../../../assets/images/hover-cart.jpg" class="cart-thumb" alt="" /></a>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer_panel content_space">
                    ...
                    <ul class="about_foot">
                        ...
                        <li>
                            <span><img src="../../../assets/images/paymennt1.png" alt="payment"></span>
                            <span><img src="../../../assets/images/payment2.png" alt="payment"></span>
                            <span><img src="../../../assets/images/payment3.jpg" alt="payment"></span>
                            <span><img src="../../../assets/images/payment4.png" alt="payment"></span>
                            <span><img src="../../../assets/images/payment5.png" alt="payment"></span>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <p>Copyright &copy; 2024 <a href="#.">Conte tecnologia</a>. Todos os direitos reservados.</p>
            </div>
            <div class="col-sm-8">
                <ul class="social">
...
<script src="../../../assets/js/jquery.final-countdown.js"></script>
