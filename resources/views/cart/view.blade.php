                                    ...
                                    <tr>
                                        ...
                                        <form action="{{route('cart.update')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <td>
                                                <div class="input-group spinner">
                                                    <input type="number" name="data[quantidade]" min="1" class="form-control item-quantity text-center" value="{{$item['quantity']}}" data-item-id="{{ $item['id_produto'] }}">
                                                    <input type="hidden" name="data[id_produto]" value="{{$item['id_produto']}}">
                                                    <input type="hidden" name="data[id_dummy_cart]" value="{{$item['id']}}">
                                                </div>
                                            </td>
                                            <td class="price">
                                            ...
                                            <td>
                                                <button style="border: hidden; background-color: #ffffff"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                            </td>
                                        </form>
                                        <form action="{{ route('cart.remove') }}" method="POST">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button style="border: hidden; background-color: #ffffff">X</button>
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
                ...
                <div class="row" >
                    ...
                    <div class="col-sm-4">
                        <div class="shop_measures margintop40">
                            ...
                            <a href="/checkout/create" class="uppercase btn-light border-radius margintop30">Proceder com checkout</a>
